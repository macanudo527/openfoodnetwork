...
class Enterprise < ApplicationRecord
  ...
  validates :instagram, 
format: { with: VALID_INSTAGRAM_REGEX, message: Spree.t('errors.messages.invalid_instagram_url') }, allow_blank: true
  ...
  def plus_parents_and_order_cycle_producers(order_cycles)
    ...
    Enterprise.not_hidden.is_primary_producer.parents_of_one_union_others(id, 
oc_producer_ids | [id])
  end
